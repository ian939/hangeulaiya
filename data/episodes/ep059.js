  ...
  AIYA.registerEpisode(
{
  ...
  "title": "싫다",
  "videoId": "BJYN1SlGhLg",
  "objective": "받침 'ㅀ'을 인식한다.",
  "focus": "겹받침 ㅀ — 쓰는 것과 소리가 달라요 [실타]",
  "jamo": {
    "new": [
      "받침 ㅀ"
    ]
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "prompt": "'싫다' 전체를 만들어 보세요. 첫 자음은 넣어 두었어요.",
          "decoys": [
            {
              "jamo": "ㄹ",
              "relation": "clusterPart"
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          "target": "시",
          "kind": "syllable",
          "prompt": "먼저 '시' 를 따라 써 보세요",
          "note": "받침이 없는 글자예요."
        },
        {
          "target": "싫",
          "kind": "syllable",
          "prompt": "이제 '싫' 을 따라 써 보세요",
          "note": "받침이 들어가면서 위의 글자가 조금 눌려요. 방금 쓴 것과 비교해 보세요!"
        },
        {
          "target": "싫다",
          "kind": "word",
          "prompt": "'싫다' 을 따라 써 보세요",
      ...
      "cuts": [
        {
          "order": 1,
          "at": 114,
          "caption": "훈민이가 책을 읽는데 정음이가 옆에서 자꾸 장난을 쳤어요.",
          "pic": {
            "kind": "scene",
            "sceneKind": "situation"
          }
        },
        {
          "order": 2,
          "at": 207,
          "caption": "싫다고 말하고 싶은데 '싫다' 를 쓸 줄 몰랐어요.",
          "pic": {
            "kind": "scene",
            "sceneKind": "problem"
          }
